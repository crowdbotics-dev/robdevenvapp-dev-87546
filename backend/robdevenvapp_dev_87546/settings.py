"""
Django settings for robdevenvapp_dev_87546 project.
...
ROOT_URLCONF = 'robdevenvapp_dev_87546.urls'
...
WSGI_APPLICATION = 'robdevenvapp_dev_87546.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "robdevenvapp_dev_87546 API",
    "DESCRIPTION": "API documentation for robdevenvapp_dev_87546 App",
    "VERSION": "v1",
}
